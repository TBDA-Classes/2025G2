...
| Atle Sund | Frontend/Backend | Backend | Worked on the ETL script to facilitate date inputs, this way it will be easier to test. Will also add sensor as an argument.  | 2025-11-25 | 1.5 |
---
