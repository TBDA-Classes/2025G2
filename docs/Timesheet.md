...
| Andres Janeiro | Data Analyst | Queries | Identify and study the exact times of the machine | 2025-11-14 | 1.5 |
...
| Andres Janeiro | Data Analyst | Queries | Review Figma Data & Graph Feasibility | 2025-11-24 | 1 |
...
| Andres Janeiro | Data Analyst | Queries | Finalize the queries for the first Figma Page | 2025-12-01 | 2 |
...
| Jovan Bajcetic | UI/UX + Scrum master | Documentation | Final version of the project documentation content + added code/queries + improved aesthetics | 2025-12-13 | 4 |
