...
* ``/dashboard/alerts`` - Alerts summary and details
...
* **Datepicker:**  
  MUI DatePicker with min/max date restrictions from data.

* **BoxPlot:**  
  Temperature distribution (Nivo)

* **TimelineChart:**  
  Machine state segments (Nivo)
